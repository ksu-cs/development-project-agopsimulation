...
*K-5 Student Lessons* - Not Started
...
*6-8 Student Dashboard* - Not Started
...
*9-12 Student Dashboard* - Not Started
...
*Adding a new class* - Not Started
...
*Viewing students in a class* - Not Started
...
*Viewing all current lessons in a class curriculum* - Not Started
...
*Viewing and searching new lessons* - Not Started
...
*The Microworld* - In Development

* On left half of screen is a block library section where all the “unlocked” coding blocks are housed and are able to be dragged - Finished
* To the right of the block library section is the coding playground where the blocks will be placed and connected together - Finished
* On right side of screen is the simulation screen that will have the first frame of the simulation displayed with being greyed out to indicate that it is stopped - Finished
* Should be able to move the layout of the screen - Not Started
* Should be able to run the blocks in the coding playground which affects the simulation screen - Finished
* Should be able to stop simulation while running - Finsihed
* Should be able to view the current lesson information - Not Started
* Should be able to unlock blocks depending on grade level - Not Started
* Should be able to save custom block templates which can be used at later points - Not Started  
* Should be able to leave simulation with saved work in coding playground and saved lesson progress - Not Started
* It will provide the tools and functionality necessary to simulate agriculture growth rates/necessities - In Development

*First Simulation: Combine Harvester* - In Development

* Initial screen layout should be as follows - Finished
...
* Should be able to turn on/off header of harvester - Finished
* Should be able to move harvester forwards or backwards - Finished
* Should be able to turn harvester 360° - Finished
* Should be able to collect crops for yield if header of harvester is on - Finished
...
* Should be able to turn seeder on - Finished
...
* Should be able to stop simulation while running - Finished
* Should be able to reset simulation to initial state - Finished
* Upon reaching lesson completion condition, the simulation should stop and notify the user that the lesson is completed - Not Started

*Coding Blocks* - Finished
